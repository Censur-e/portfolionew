...
export const UI_TRANSLATIONS = {
  fr: {
    ...
    projectsTitleBefore: "Ce que j'ai ",
    projectsTitleEmphasis: "conçu & lancé.",
    projectsIntro: "Une sélection de travaux récents — lobbies, HUD, identités, intros narratives. Glisse, scrolle ou swipe.",
    emptyProjects: "Aucun projet dans cette catégorie pour le moment.",
  ...
  en: {
    ...
    projectsTitleBefore: "What I've ",
    projectsTitleEmphasis: "designed & launched.",
    projectsIntro: "A selection of recent work — lobbies, HUDs, identities, narrative intros. Scroll, swipe, explore.",
